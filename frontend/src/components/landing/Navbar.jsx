...
export default function Navbar() {
  return (
    <div className="flex justify-center my-7">
      <div className="navbar flex flex-row justify-around w-7xl h-16 items-center rounded-full border border-my-border bg-transparent backdrop-blur-2xl top-0 shadow-[0_8px_8px_rgba(0,0,0,0.4)]">
